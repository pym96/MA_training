...
: ${AMENT_CURRENT_PREFIX:="/home/yiming/training/train/ros_rv/install/my_serial_node"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_serial_node/environment/library_path.sh"
