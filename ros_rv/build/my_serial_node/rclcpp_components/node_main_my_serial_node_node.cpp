...
#define NODE_MAIN_LOGGER_NAME "my_serial_node_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmy_serial_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_serial_driver::RMSerialDriver>";
